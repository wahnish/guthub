...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { description: @dish.description, ingredients: @dish.ingredients, name: @dish.name }
    end
  ...
  test "should update dish" do
    put :update, id: @dish, dish: { description: @dish.description, ingredients: @dish.ingredients, name: @dish.name }
    assert_redirected_to dish_path(assigns(:dish))
  end
